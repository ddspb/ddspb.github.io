...
(function (exports) {
     ...
     */
    var argOptions = { "construct": "Metrika2", "callbackPostfix": "2", "version": "5re784txq2uptyzu7pb" };
    ...
    */
    ...
    var iterateTransports = function (ctx, transports, urls, senderInfo, rawOpt, urlIndex, transportIndex) {
        ...
        if (!query[TELEMETRY_QUERY_KEY]) {
            ...
            if (telemetry) {
                telemetry.setVal(TRANSPOR_ID_BR_KEY, id);
    ...
    var executeIterator = function (ctx, iterFn, maxTime, timeout, iterLoop) {
        ...
        var taskObj = function (reject, resolve) {
            ...
            var recursive = function () {
                ...
                if (!taskObj.flush) {
                    setDefer(ctx, recursive, timeout);
                }
                else {
    ...
    var iterateTaskWithConstraints = function (ctx, collection, callback, maxTime, timeout, errorNamspace) {
        if (maxTime === void 0) { maxTime = 1; }
        if (timeout === void 0) { timeout = 200; }
        if (errorNamspace === void 0) { errorNamspace = 'itc'; }
        var iterator = iterForOf(collection, callback);
        var task = executeIterator(ctx, iterator, maxTime, timeout);
    ...
    */
    ...
    var itemsUnknownEarlyOn = (_a$2 = {},
        _a$2['responseEnd'] = 1,
        _a$2['domInteractive'] = 1,
        _a$2['domContentLoadedEventStart'] = 1,
        _a$2['domContentLoadedEventEnd'] = 1,
        _a$2['domComplete'] = 1,
        _a$2['loadEventStart'] = 1,
        _a$2['loadEventEnd'] = 1,
        _a$2['unloadEventStart'] = 1,
        _a$2['unloadEventEnd'] = 1,
        _a$2['secureConnectionStart'] = 1,
        _a$2);
    ...
    var LONGTASK_KEY = 'lt';
    var LONGTASK_BR_KEY = LONGTASK_KEY;
    ...
    var CLMAP_CLICKS_BR_KEY = 'clc';
    var IS_ACTIVE_WINDOW_BR_KEY = 'aw';
    var BRINFO_FLAG_GETTERS = (_a$3 = {},
        _a$3[BUILD_FLAGS_BR_KEY] = /* @__PURE__ */ bindArg(argOptions.version, firstArg),
        _a$3[NET_TYPE_BR_KEY] = netType,
        _a$3[FIRST_PAINT_BR_KEY] = firstPaint,
        _a$3[FALSE_URL_BR_KEY] = isFalseURL,
        _a$3[DOCUMENT_ENCODING_BR_KEY] = getDocumentEncoding,
        _a$3[BROWSER_LANGUAGE_BR_KEY] = getNavigatorLanguage,
        _a$3[NOINDEX_BR_KEY] = function (ctx, options, senderParams) {
        ...
        _a$3[BUILD_VERSION_BR_KEY] = /* @__PURE__ */ bindArg(config.buildVersion, firstArg),
        _a$3[COUNTER_NUMBER_BR_KEY] = getCounterNumber,
        _a$3[IS_DESKTOP_BR_KEY] = getDesktopFlag,
        _a$3[LS_ID_BR_KEY] = /* @__PURE__ */ memo(function (ctx, options) {
        ...
        _a$3[HID_BR_KEY] = getHid,
        _a$3[TIMEZONE_BR_KEY] = timeZone,
        _a$3[TIMESTAMP_BR_KEY] = timeStamp,
        _a$3[SECONDS_BR_KEY] = timeSeconds,
        _a$3[COOKIES_ENABLED_BR_KEY] = /* @__PURE__ */ pipe(/* @__PURE__ */ ctxPath('navigator.cookieEnabled'), toOneOrNull),
        _a$3[RANDOM_NUMBER_BR_KEY] = /* @__PURE__ */ pipe(firstArg, getRandom),
        _a$3[REQUEST_NUMBER_BR_KEY] = function (ctx, options, senderParams) {
            var urlParams = senderParams.urlParams;
        ...
        _a$3[UID_BR_KEY] = getUidFlag,
        _a$3[IS_TURBO_PAGE_BR_KEY] = /* @__PURE__ */ pipe(secondArg, isTurboPage, toOneOrNull),
        _a$3[TURBO_PAGE_ID_BR_KEY] = /* @__PURE__ */ pipe(secondArg, getTurboPageId),
        _a$3[VIEWPORT_SIZE_BR_KEY] = function (ctx) {
            var _a = getViewportSize(ctx), width = _a[0], height = _a[1];
            return width + "x" + height;
        },
        _a$3[SCREEN_SIZE_BR_KEY] = function (ctx) {
        ...
        _a$3[DEVICE_PIXEL_RATIO_BR_KEY] = /* @__PURE__ */ ctxPath('devicePixelRatio'),
        _a$3[IS_IFRAME_BR_KEY] = /* @__PURE__ */ pipe(isIframe, toOneOrNull),
        _a$3[IS_JAVA_ENABLED] = /* @__PURE__ */ pipe(getJavaEnabled, toOneOrNull),
        _a$3[IS_SAME_ORIGIN_AS_TOP_WINDOW] = function (ctx) {
            if (isIframe(ctx)) {
    ...
    }
    {
        mix(BRINFO_FLAG_GETTERS, (_b = {},
            ...
            _b[IS_EU] = function (ctx) {
                return getGlobalStorage(ctx).getVal(IS_EU_CONFIG_KEY);
            },
            ...
            _b));
        TELEMETRY_FLAG_GETTERS[IS_ACTIVE_WINDOW_BR_KEY] = function (ctx) {
    ...
    {
        TELEMETRY_FLAG_GETTERS[CLMAP_CLICKS_BR_KEY] = function (ctx) {
            return globalStorage(ctx).getVal(GLOBAL_STORAGE_CLICKS_KEY);
        };
    }
    {
        TELEMETRY_FLAG_GETTERS[LONGTASK_BR_KEY] = function (ctx) {
    ...
    var watchSyncFlags = function (inputFlags) {
        ...
        return function (ctx, provider, opt) { return ({
            beforeRequest: function (senderParams, next) {
                ...
                var telemetry = addTelemetryToSenderParams(senderParams);
                cForEach(function (flag) {
                    var isBrinfoFlag = !!BRINFO_FLAG_GETTERS[flag];
    ...
    var STATUS_TO_PARAMS = (_a$4 = {},
        _a$4[GDPR_OK] = 'ok',
        _a$4[GDPR_OK_VIEW_DEFAULT] = 'ok-default',
        _a$4[GDPR_OK_VIEW_DETAILED] = DETAILED_PREFIX,
        _a$4[GDPR_OK_VIEW_DETAILED + "-0"] = DETAILED_PREFIX + "-all",
        _a$4[GDPR_OK_VIEW_DETAILED + "-1"] = DETAILED_PREFIX + "-tech",
        _a$4[GDPR_OK_VIEW_DETAILED + "-2"] = DETAILED_PREFIX + "-tech-analytics",
        _a$4[GDPR_OK_VIEW_DETAILED + "-3"] = DETAILED_PREFIX + "-tech-other",
        _a$4);
    var sendGDPRParams = function (ctx, counterOptions) {
        if (isYandexOwnerDomain(ctx)) {
            ...
            if (paramsFn && params.length) {
                paramsFn('__ym', 'gdpr', /* @__PURE__ */ cFilter(Boolean, params));
            }
        }
    };
    ...
    */
    ...
    var middlewareList = (_a$6 = {},
        _a$6[HIT_PROVIDER] = commonMiddlewares,
        _a$6[ERROR_LOGGER_PROVIDER] = [],
        _a$6);
    {
    ...
    var providerMap = (_a$7 = {},
        _a$7[HIT_PROVIDER] = useSenderWatch,
        _a$7[ERROR_LOGGER_PROVIDER] = /* @__PURE__ */ bindArg(fallbackSender, firstArg),
        _a$7);
    {
    ...
    var artificialHitProvider = function (ctx, counterOpt) {
        ...
        return function (url, title, referer, params, callback, fnCtx) {
            ...
            sender(mix(senderOpt, {
                ...
                .then(logHit)["catch"](errorLogger(ctx, 'p.ar.s'))
                .then(bindArgs([ctx, options.callback || noop, options.ctx], callUserCallback));
            return undefined;
        };
    };
    ...
    var ProtoBufferSerializer = /** @class */ (function () {
        ...
        ProtoBufferSerializer.prototype.serialize = function (data) {
            ...
            var iterLength = executeIterator(this.ctx, encoderLength, 20, 100, iterPopUntilMaxTime);
            return iterLength(taskChain(function (lengthData) {
                ...
                var iterBytes = executeIterator(_this.ctx, encoderBytes, 20, 100, iterPopUntilMaxTime);
                return iterBytes;
     ...
     */
    var rawVisor2Buffer =  (_a$8 = /** @class */ (function (_super) {
    ...
    var LENGTH_LIMITS = (_a$9 = {},
        _a$9[PUBLISHER_ARTICLE_TYPE] = ARTICLE_LENGTH_LIMIT,
        _a$9[PUBLISHER_REVIEW_TYPE] = ARTICLE_LENGTH_LIMIT,
        _a$9[PUBLISHER_QA_TYPE] = 0,
        _a$9);
                ...
                if (force || (!notBounceHitSent && !counterLS.isBroken)) {
                    ...
                    if (force ||
                        ...
                        sender(senderOpt, counterOpt)
                            ...
                            .then(bindArgs([ctx, options['callback'], options['ctx']], callUserCallback), errorLogger(ctx, 'l.o.l'));
                    }
                }
            };
        };
    ...
    var useGoal = /* @__PURE__ */ ctxErrorLogger('go.in', function (ctx, counterOptions, schemePrefix, callback) {
        ...
        return function (goalName, rawParams, rawUserCallback, rawfnCtx) {
            ...
            })["catch"](errorLogger(ctx, 'g.s'))
                .then(bind(callUserCallback, null, ctx, userCallback, fnCtx));
        };
    });
    ...
    var sendClickLink = function (ctx, counterOptions, options, callback) {
        ...
        options
            ...
            .then(callback || noop)
            .then(getLoggerFn(ctx, counterOptions, prefix + ". Counter " + counterOptions.id + ". Url: " + options.url, options))["catch"](errorLogger(ctx, 'cl.p.s'))
            .then(bindArgs([ctx, options.callback || noop, options.ctx], callUserCallback));
    };
    ...
    var getUserDataStorage = function (ctx, counterSettingsBK, counterOptions) {
    ...
    var PATHS = (_a$a = {},
        _a$a[DEVICESYNC_PROVIDER] = 'p',
        _a$a[MOBILE_UID_SYNC_PROVIDER] = 'i',
        _a$a);
    ...
    var sync = function (ctx, counterSettings, syncOptions) {
        var counterOptions = syncOptions.counterOptions;
        var timer = TimeOne(ctx);
        var userDataStorage = getUserDataStorage(ctx, counterSettings[COUNTER_SETTINGS_USER_DATA_KEY], counterOptions);
    ...
    function destructingDecorator(ctx, counterOptions, fn) {
    ...
    var rawParams = function (ctx, counterOptions) {
        return errorLogger(ctx, 'pa.c', function a() {
            var _a, _b;
            // eslint-disable-next-line prefer-rest-params
            var args = argsToArray(arguments);
            ...
            sender({
                ...
                .then(shouldLogParams ? logParams : noop)["catch"](errorLogger(ctx, 'p.s'))
                .then(bind(callUserCallback, null, ctx, callback, ctxInfo));
        });
    };
    ...
    var useExperiments = /* @__PURE__ */ ctxErrorLogger('exps.int', function (ctx, counterOptions) {
        return errorLogger(ctx, 'e.m', function (experimentName, rawCallback, rawCtx) {
            var _a, _b;
            ...
            if (experimentName && experimentName.length > 0) {
                ...
                return sender({
                    ...
                    urlParams: (_b = {},
                        ...
                        _b),
                }, counterOptions).then(bind(callUserCallback, null, ctx, rawCallback, rawCtx), errorLogger(ctx, 'exps.s'));
            }
            return undefined;
        });
    });
    ...
    var GTAG_REPLACE_KEYS = (_a$c = {},
        _a$c['transaction_id'] = 'id',
        _a$c['item_id'] = 'id',
        _a$c['item_name'] = 'name',
        _a$c['item_brand'] = 'brand',
        _a$c['promotion_name'] = 'coupon',
        _a$c['index'] = 'position',
        _a$c['item_variant'] = 'variant',
        _a$c['value'] = 'revenue',
        _a$c[GTAG_CATEGORY] = 'category',
        _a$c);
    ...
    function selfReturnDecorator(ctx, counterOptions, fn) {
    ...
    function decoratorPipe(ctx, counterOptions, decorators, method) {
        return function () {
            var enableDecorators = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                enableDecorators[_i] = arguments[_i];
            }
            var enableAllDecorators = cEvery(function (enable) { return enable === false; }, enableDecorators);
            var returnPureFn = enableDecorators.length > 0 ? enableAllDecorators : false;
            if (returnPureFn || !decorators.length || !method) {
                return method;
            }
            return /* @__PURE__ */ pipe.apply(void 0, cReduce(function (decrs, decorator, i) {
                if (enableDecorators[i] === false) {
                    return decrs;
                }
                return decrs.concat(function () {
                    var args = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        args[_i] = arguments[_i];
                    }
                    return decorator.apply(void 0, /* @__PURE__ */ __spreadArrays([ctx, counterOptions], args));
                });
            }, [], decorators))(method);
        };
    }
    ...
    var rawSetUserID = function (ctx, counterOptions) {
        return errorLogger(ctx, 'suid.c', function a(id, callback, callbackCtx) {
            var counterInstance = getCounterInstance(ctx, counterOptions);
            var ctxConsole = getConsole(ctx);
    ...
    var rawGetClientID = function (ctx, counterOptions) {
        return errorLogger(ctx, 'guid.c', function a(callback) {
    ...
    var encodeEventType = (_a$e = {},
        ...
        _a$e['touchend'] = 15,
        _a$e['touchcancel'] = 16,
        _a$e['touchforcechange'] = 17,
        _a$e['canvasMethod'] = 18,
        _a$e['canvasProperty'] = 19,
        _a$e['zoom'] = 20,
        _a$e['resize'] = 21,
        _a$e['mediaMethod'] = 22,
        _a$e['mediaProperty'] = 23,
        _a$e['keystroke'] = 24,
        _a$e['deviceRotation'] = 25,
        _a$e['fatalError'] = 26,
        _a$e['hashchange'] = 27,
        _a$e['stylechange'] = 28,
        _a$e);
    ...
    var rawVisor2ProtoBufferSerializer =  /** @class */ (function () {
            ...
            Visor2ProtoBufferSerializer.prototype.serialize = function (data, forceSync) {
                ...
                return taskDone(taskChain(function (taskData) {
                    ...
                    var iterLength = executeIterator(_this.ctx, encoderLength, syncTimeOut, 100, iterPopUntilMaxTime);
                    ...
                    var lengthResult = lengthData.slice(-4);
                    var encoderBytes = protoWriteBytes(_this.ctx, lengthResult);
                    var iterBytes = executeIterator(_this.ctx, encoderBytes, syncTimeOut, 100, iterPopUntilMaxTime);
    ...
    */
    ...
    var _a$f;
    var consoleTabComponent =  (_a$f = /** @class */ (function (_super) {
        ...
        _a$f.tabName = 'console',
        _a$f.styles = CONSOLE_TAB_STYLES,
        _a$f.windowStyles = [],
        _a$f) ;
    ...
    var _a$g;
    var requestTabComponent =  (_a$g = /** @class */ (function (_super) {
        ...
        _a$g.tabName = 'requests',
        _a$g.styles = REQUESTS_TAB_STYLES,
        _a$g.windowStyles = [],
        _a$g) ;
    ...
    var countersTabComponent =  (_a$h = /** @class */ (function (_super) {
        ...
        _a$h.tabName = 'counters',
        _a$h.styles = COUNTERS_TAB_STYLES,
        _a$h.windowStyles = [],
        _a$h) ;
    ...
    var _a$i;
    var publisherTabComponent =  (_a$i = /** @class */ (function (_super) {
        ...
        _a$i.tabName = 'publishers',
        _a$i.styles = PUBLISHER_TAB_STYLES,
        _a$i.windowStyles = HIGHLIGHT_ELEMENT_STYLES,
        _a$i) ;
    ...
    var _a$j;
    var errorTabComponent =  (_a$j = /** @class */ (function (_super) {
    ...
    var _a$k;
    var paramsTabComponent =  (_a$k = /** @class */ (function (_super) {
            ...
            _a$k.tabName = 'parameters',
            _a$k.styles = PARAMS_TAB_STYLES,
            _a$k.windowStyles = [],
            _a$k) ;
    ...
    var ecommerceTabComponent =  (_a$l = /** @class */ (function (_super) {
                __extends(ParametersTabComponent, _super);
                function ParametersTabComponent() {
                    var _this = _super.call(this) || this;
                    _this.state = { list: [] };
            ...
            _a$l.tabName = 'ecommerce',
            _a$l.styles = ECOMMERCE_TAB_STYLES,
            _a$l.windowStyles = [],
            _a$l) ;
    ...
    var _a$m;
    var eventsTabComponent =  (_a$m = /** @class */ (function (_super) {
    ...
    var MetrikaCounter = /** @class */ (function () {
        function MetrikaCounter(counterId, counterParams, counterType, counterDefer) {
            ...
            return errorLogger(window, 'c.i', function () {
                ...
                var decorators = [destructingDecorator, selfReturnDecorator];
                var callProvider = function (fn) {
                    return destructingDecorator(ctx, counterOptions, fn)(ctx, counterOptions);
                };
                function decoratorPipeFn(method) {
                    return decoratorPipe(ctx, counterOptions, decorators, method);
                }
                ...
                {
                    // artificial hit
                    _this[METHOD_NAME_HIT] = decoratorPipeFn(useArtificialHitProvider(ctx, counterOptions))();
                }
                {
                    // params
                    _this[METHOD_NAME_PARAMS] = decoratorPipeFn(useParams(ctx, counterOptions))();
                }
                {
                    // trackHash
                ...
                {
                    // goals
                    _this[METHOD_NAME_GOAL] = decoratorPipeFn(useGoal(ctx, counterOptions))();
                }
                {
                    // experiments
                    _this[METHOD_NAME_EXPERIMENTS] = decoratorPipeFn(useExperiments(ctx, counterOptions))();
                }
                {
                    // trigger event
                ...
                }
                {
                    ...
                    _this[METHOD_NAME_NOT_BOUNCE] = decoratorPipeFn(getPath(notBounceProvider, deobfuscate({ notBounce: 1 })))();
                    {
                        // accurateTrackBounce
                        _this[METHOD_NAME_ACCURATE_TRACK_BOUNCE] = decoratorPipeFn(getPath(notBounceProvider, deobfuscate({ accurateTrackBounce: 1 })))();
                    }
                }
                {
                    // yan money
                ...
                }
                {
                    ...
                    _this[METHOD_NAME_EXTERNAL_LINK_CLICK] = decoratorPipeFn(getPath(linkMethods, deobfuscate({ extLink: 1 })))();
                    _this[METHOD_NAME_ADD_FILE_EXTENSION] = decoratorPipeFn(getPath(linkMethods, deobfuscate({ addFileExtension: 1 })))();
                    _this[METHOD_NAME_FILE_CLICK] = decoratorPipeFn(getPath(linkMethods, deobfuscate({ file: 1 })))();
                    _this[METHOD_NAME_TRACK_LINKS] = decoratorPipeFn(getPath(linkMethods, deobfuscate({ trackLinks: 1 })))();
                }
                {
                    // ecommerce
                ...
                }
                {
                    ...
                    _this[METHOD_NAME_ECOMMERCE_ADD] = decoratorPipeFn(legacyEcommerceAdd(ctx, counterOptions))();
                    _this[METHOD_NAME_ECOMMERCE_REMOVE] = decoratorPipeFn(legacyEcommerceRemove(ctx, counterOptions))();
                    _this[METHOD_NAME_ECOMMERCE_DETAIL] = decoratorPipeFn(legacyEcommerceDetail(ctx, counterOptions))();
                    _this[METHOD_NAME_ECOMMERCE_PURCHASE] = decoratorPipeFn(legacyEcommercePurchase(ctx, counterOptions))();
                }
                {
                    var paramsFn = callProvider(userParams);
                    // userParams
                    _this[METHOD_NAME_USER_PARAMS] = decoratorPipeFn(paramsFn || noop)();
                }
                {
                    // destruct
                    _this[METHOD_DESTRUCT] = decoratorPipeFn(destruct(ctx, counterOptions, unsubscribeMethods))(true, false);
                }
                {
                    // pluginFeature
                ...
                }
                {
                    ...
                    // setUserID
                    _this[METHOD_NAME_SET_USER_ID] = decoratorPipeFn(setUserIdFn || noop)();
                }
                {
                    // getClientIDx
                ...
                }
                {
                    ...
                    {
                        // clickmap method
                        _this[METHOD_NAME_CLICK_MAP] = decoratorPipeFn(useClickmapMethodProvider(ctx, counterOptions))();
                    }
                }
                {
                ...
                {
                    // enableAll
                    _this[METHOD_NAME_ENABLE_ALL] = decoratorPipeFn(useEnableAllProvider(ctx, counterOptions))();
                }
                {
